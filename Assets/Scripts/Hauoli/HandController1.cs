...
public class HandController1 : MonoBehaviour, IHauoliHandler
{
    private int frame = 0;
    ...
    private bool isDebugPosInfo = false;
    ...
    void Start()
    {
        Debug.Log(String.Format("HandController 1 Start: {0}", clientIndex));
    ...
    void SetStaticParameters()
    {
        ...
        Debug.Log(String.Format("Controller 1 - Meter to Pixel Scale: {0}, {1}, {2}"
    ...
    {
        Debug.Log("Controller 1 set to single-player mode");
    ...
    {
        Debug.Log("Controller 1 set to two-player mode");
        mode = Mode.TwoPlayer;

        // Initial position of the phone, in the order of x,y,z in Hauoli Coordinate System
        HAUOLI_CENTER[0] = 0.7f;
    ...
    void SetHauoliCenterToCurrentPos()
    {
        if (isDebugResetPos)
        {
            Debug.Log("Controller 1 reset Pos to " + mCoor[0] + ", "
                      + mCoor[1] + ", " + mCoor[2]);
        }
    ...
    public void ReadBufferData(HauoliEventData eventData)
    {
        ...
        if (isDebugHauoliInfo)
        {
            ...
            {
                Debug.Log("hand 1 rcv = " + mCoor[0] + "," + mCoor[1] + "," + mCoor[2]);
